import { microserviceUrl } from "./config";

const SVC_ENDPOINT = microserviceUrl;
// const SVC_ENDPOINT = "https://dev1.commerceintelligence.ai";
// const SVC_ENDPOINT = "https://uat1.commerceintelligence.ai";
// const SVC_ENDPOINT = "https://test1.commerceintelligence.ai";
...
Object.keys(endpoints).map(endpoint => {
	actual_endpoints[endpoint] = `${SVC_ENDPOINT}${endpoints[endpoint]}`;
	proxy_endpoints[endpoint] = `/api${endpoints[endpoint]}`;
});

const service_endpoints = proxy_endpoints;
